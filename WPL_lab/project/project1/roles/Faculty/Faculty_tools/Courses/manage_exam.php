...
if (!$offering_id) {
    ...
    require_once include_file('templates/layout/master_base.php'); // use include_file() instead of ../../
    $conn->close();
    exit;
}

// Verify access for the selected course
$stmt = $conn->prepare("
...
$content = ob_get_clean();
$page_title = 'Manage Exams';
require_once include_file('templates/layout/master_base.php'); // use include_file() here as well
$conn->close();
